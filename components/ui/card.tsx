    ...
    <>
      {active ? (
        <motion.div
          ...
          exit={{ x: exitX }}
          className="cursor-grab absolute flex  max-h-[80%] flex-col rounded-xl bg-gray-900 bg-clip-border text-light-1 shadow-2xl self-center items-center justify-center"
        >
