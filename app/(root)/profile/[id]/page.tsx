...
const ProfilePage = (props: any) => {
    ...
    return (
          ...
          <main className="max-w-4xl flex items-center h-auto lg:h-screen flex-wrap mx-auto my-32 lg:my-0">
            ...
            >
              <div className="p-4 md:p-12 text-center lg:text-left">
                ...
                ></div>
                <h1 className="text-3x1 font-bold pt-8 lg:pt-0">
                  {user?.name}
                </h1>
                ...
                <div className="pt-12 pb-8">
                  <button className="bg-orange-700 hover:bg-green-700 text-white font-bold py-2 px-4 rounded-full">
                    Message
                  </button>
                </div>
      ...
      <div className="rounded border overflow-hidden shadow-lg">
        <a href="#"></a>
        <div className="rounded border relative grid grid-cols-3 gap-4 items-center">
        {user?.likedRestaurants?.map((restaurant) => (
                    <div
                      ...
                      <a href="#">
                        <Image 
                          className="w-10 h-10 rounded-full object-cover min-w-10 min-h-10 item-center" 
